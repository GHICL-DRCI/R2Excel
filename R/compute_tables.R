...
#'
#' Computation follows stddiff r pkg implementation : https://cran.r-project.org/web/packages/stddiff/index.html
...
#   modified_state,
#   varstrat = "election", 
#   vars = c( "yes_no_french_question", "binary_test",
#     "state.division", "state.region"
#   ) 
# )
